        ...
        >
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="min-w-0">
              <p className="mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-indigo-300 sm:text-sm">
                Contacto
              </p>
              ...
              <a
                ...
                className="mt-8 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 px-6 py-4 font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:-translate-y-1 sm:w-auto"
              >
                Envíame un correo
                <Send size={18} />
              </a>
            ...
            <div className="min-w-0 space-y-4">
              <a
                href="mailto:edgar.rdz.dev@gmail.com"
                className="flex min-w-0 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.035] p-4 text-slate-300 transition hover:border-indigo-400/30 hover:bg-white/[0.055] sm:p-5"
              >
              ...
              <div className="flex min-w-0 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.035] p-4 text-slate-300 sm:p-5">
                <MapPin className="shrink-0 text-indigo-400" size={20} />
