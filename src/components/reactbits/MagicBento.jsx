...
const ExperienceVisual = ({ type }) => {
  if (type === "dashboard") {
    return (
      <div className="magic-bento-card__system-visual magic-bento-card__system-visual--dashboard">
        <div className="system-window">
          ...
          <div className="system-window__body">
            <div className="system-line system-line--active">
              <span>status</span>
  ...
  if (type === "network") {
    return (
      <div className="magic-bento-card__system-visual magic-bento-card__system-visual--network">
        <div className="network-map">
          <span className="network-node network-node--one">Meta</span>
          <span className="network-node network-node--two">APIs</span>
          <span className="network-node network-node--three">Logs</span>
          <span className="network-node network-node--four">Web</span>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card) => {
          ...
          const baseClassName = `magic-bento-card ${
            hasVisual ? "magic-bento-card--has-visual" : ""
          ...
          const content = (
            <>
              ...
              {card.visual && <ExperienceVisual type={card.visual} />}

              <div className="magic-bento-card__header">
                <div>
                  <div className="magic-bento-card__label">{card.label}</div>
                  <div className="magic-bento-card__eyebrow">{card.eyebrow}</div>
                </div>
              </div>
              ...
              <div className="magic-bento-card__content">
                ...
                <div className="magic-bento-card__meta">
                  {card.meta.map((item) => (
